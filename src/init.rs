...
pub fn run_init() -> Result<()> {
    ...
    let config = ProjectConfig { ai_apps: selected_apps };
  ...
  "ai_apps": [{}
    ...
    println!("\nYou can now run:");
    println!("  mai create . <branch-prefix>        # Create worktrees with iTerm2");
    println!("  mai create . <branch-prefix> --tmux  # Create worktrees with tmux");
